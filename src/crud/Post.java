...
public class Post implements Serializable {
    ...
    // --- Privacy Settings ---
    private boolean isFollowersOnly;      // Visible only to followers
    private boolean allowAnonComments;    // Can people comment anonymously?
    private boolean followersOnlyComments;// Can only followers comment?

    // --- Constructor ---
    public Post(String author, String authorAvatarUrl, String content, String imageUrl, 
                boolean isFollowersOnly, boolean allowAnonComments, boolean followersOnlyComments) {
        this.id = nextId++;
        this.author = author;
        ...
        this.followersOnlyComments = followersOnlyComments;
    ...
    public boolean isFollowersOnly() { return isFollowersOnly; }
    public boolean isAllowAnonComments() { return allowAnonComments; }
    public boolean isFollowersOnlyComments() { return followersOnlyComments; }
    ...
    public void addRepost() { this.repostCount++; }
    public void setAsRepost(String originalAuthor) { this.originalPostAuthor = originalAuthor; }
    public boolean isRepost() { return this.originalPostAuthor != null; }
    ...
    public String getTimestampString() { return this.timestamp.format(formatter); }
